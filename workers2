        ...
        if (locElement) {
          ...
          if (locData) {
            ...
            if (!isNaN(latitude) && !isNaN(longitude)) {
              ...
              leafletScript.onload = () => initMap(latitude, longitude);
          ...
          <div class="card">
            ...
            <div class="card-content">
              <div id="location-data" data-loc="${data.loc}">
                ...
                <p><i class="fas fa-external-link-alt"></i> <a href="https://maps.google.com/?q=${latitude},${longitude}" target="_blank">在谷歌地图上查看</a></p>
